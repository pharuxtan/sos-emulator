...
<about_sos_emulator>
  <p class=title>About SOS Emulator</p>
  <p class=description>
    ...
    Idea is originally from SilentEcho (<span id="https://github.com/SilentEchoUK/sos-emulator-electron" on:click={linkClick}>his version here</span>), and wanted to do my own
  </p>
</about_sos_emulator>
