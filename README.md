[![SOS Emulator Light](/images/light-icon.svg)](https://github.com/pharuxtan/sos-emulator#gh-light-mode-only)
[![SOS Emulator Dark](/images/dark-icon.svg)](https://github.com/pharuxtan/sos-emulator#gh-dark-mode-only)
...
Idea is originally from SilentEcho ([his version here](https://github.com/SilentEchoUK/sos-monorepo/tree/main/apps/emulator-electron)) and wanted to do my own

## Todo

- [X] Base application with payloads sending
- [X] Payloads queuing, with import and export for later usage
- [ ] Replay simulator